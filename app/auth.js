...
export default class Auth {
  ...
  auth0 = new auth0.WebAuth({
    domain: 'maximal.auth0.com',
    clientID: 'DuKP2lAaEt8RyNGnwOYpFNxWABUDwsVl',
    redirectUri: process.env.NODE_ENV === 'development' ? 'http://localhost:8001/callback' : 'https://imaximal.github.io/todomvc-authorization-client/callback',
    audience: 'https://todomvc-authorization',
